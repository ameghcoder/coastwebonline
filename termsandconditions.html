...
<head>
  ...
  <title>Terms and Conditions | Coast Web Online</title>
</head>
...
<body class="bg-white dark:bg-gray-800">
  <div class="flex flex-col w-full h-screen justify-between">
    ...
    <!--  First -->
    <section class="mx-5">
      <h1 class="text-4xl my-5"><strong>Terms and Conditions</strong></h1>

      <p>Welcome to coastwebonline!</p>

      <p>
        These terms and conditions outline the rules and regulations for the
        use of coastwebonline's Website, located at coastweb.online.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use coastwebonline if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing coastwebonline, you agreed
        to use cookies in agreement with the coastwebonline's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, coastwebonline and/or its licensors own the
        intellectual property rights for all material on coastwebonline. All
        intellectual property rights are reserved. You may access this from
        coastwebonline for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from coastwebonline</li>
        <li>Sell, rent or sub-license material from coastwebonline</li>
        <li>Reproduce, duplicate or copy material from coastwebonline</li>
        <li>Redistribute content from coastwebonline</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        coastwebonline does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views
        and opinions of coastwebonline,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, coastwebonline
      ...
      <p>
        coastwebonline reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant coastwebonline a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of coastwebonline; and (d) the
      ...
      <p>
        ...
        sending an e-mail to coastwebonline. Please include your name, your
      ...
      <p>
        No use of coastwebonline's logo or other artwork will be allowed for
