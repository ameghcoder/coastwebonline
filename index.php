...
<body class="dark:bg-gray-800 dark:text-gray-100">
    <div class="flex flex-col w-full h-screen justify-between">
        ...
        <!-- Header -->
        <header class="shadow-md p-4 dark:bg-gray-800 dark:text-gray-100">
            <div class="container flex justify-between h-16 mx-auto md:justify-center md:space-x-8">
                <ul class="items-stretch hidden space-x-3 md:flex">
                    <li class="flex">
                        <a rel="noopener noreferrer" href="#"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">About</a>
                    </li>
                    <li class="flex">
                        <a rel="noopener noreferrer" href="#"
                    ...
                    <li class="flex">
                        <a rel="noopener noreferrer" href="./login.php"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Login</a>
                    </li>
                </ul>
                ...
                <ul class="items-stretch hidden space-x-3 md:flex">
                    <li class="flex">
                        <a rel="noopener noreferrer" href="#pricing"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Pricing</a>
                    </li>
                    <li class="flex">
                        <a rel="noopener noreferrer" href="#"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Service</a>
                    </li>
                </ul>
        ...
        <!--  First -->
        <section class="mt-2 dark:bg-gray-800 dark:text-gray-100">
            <div
                ...
                <div
                    ...
                    <h1 class="text-5xl font-bold leadi sm:text-6xl">Own Website
                        <span class="dark:text-rose-400">Own Business</span>
                    </h1>
                    <p class="mt-6 mb-8 text-lg sm:mb-12">Create amazing website by us for all types of business and get
                        <br class="hidden md:inline lg:hidden"><span class="dark:text-rose-400">free life time
                            support</span>
                    </p>
                    <div
                        class="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                        <a rel="noopener noreferrer" href="#"
                            class="px-8 py-3 text-lg font-semibold rounded dark:bg-rose-400 dark:text-gray-900">Contact
                            us</a>
                        <a rel="noopener noreferrer" href="#"
                            class="px-8 py-3 text-lg font-semibold border rounded dark:border-gray-100">See Pricing</a>
                    </div>
                </div>
            ...
            <div class="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div class="flex flex-col items-center p-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        class="w-8 h-8 dark:text-rose-400">
        ...
        <!-- Third -->
        <div
            class="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto my-5 rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-900 dark:text-gray-100">
            ...
            <form novalidate="" class="space-y-6">
                ...
                <button type="submit"
                    class="w-full p-3 text-sm font-bold tracki uppercase rounded dark:bg-rose-400 dark:text-gray-900">Send
                    Message</button>
            </form>
        </div>
        <hr class="w-1/2 m-auto border-t border-gray-700">
        ...
        <section class="py-6 dark:bg-gray-800 dark:text-gray-100">
            <div class="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
                ...
                <p class="max-w-2xl text-center dark:text-gray-400">At a assumenda quas cum earum ut itaque commodi
                ...
                <div class="flex flex-row flex-wrap-reverse justify-center">
                    <div class="flex flex-col justify-center m-8 text-center">
                        ...
                        <p class="dark:text-gray-400">Project Manager <br> & Full Stack Developer</p>
                    </div>
                    <div class="flex flex-col justify-center m-8 text-center">
                        <img alt=""
                            class="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500"
                        ...
                        <p class="dark:text-gray-400">Backend Developer <br> & Customer Support</p>
                    </div>
                    <div class="flex flex-col justify-center m-8 text-center">
                        <img alt=""
                            class="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500"
                        ...
                        <p class="dark:text-gray-400">Frontend Developer</p>
                    </div>
                </div>
            </div>
        </section>
        <hr class="w-1/2 m-auto border-t border-gray-700">
        <section class="py-20 dark:bg-gray-800 dark:text-gray-100" id="pricing">
            <div class="container px-4 mx-auto">
                <div class="max-w-2xl mx-auto mb-16 text-center">
                    <span class="font-bold tracki uppercase dark:text-rose-400">Pricing</span>
                        ...
                        <div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                            ...
                            <ul class="flex-1 mb-6 dark:text-gray-400">
                                <li class="flex mb-2 space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        class="flex-shrink-0 w-6 h-6 dark:text-rose-400">
                                        <path fill-rule="evenodd"
                            ...
                            <button type="button"
                                class="inline-block px-5 py-3 font-semibold tracki text-center rounded dark:bg-rose-400 dark:text-gray-900">Get
                                Started</button>
                        </div>
                    </div>
                    <div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                        <div
                            class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-rose-400 dark:text-gray-900">
                            <div class="space-y-2">
                            ...
                            <a rel="noopener noreferrer" href="#"
                                class="inline-block w-full px-5 py-3 font-bold tracki text-center rounded dark:bg-gray-800 dark:text-rose-400">Get
                                Started</a>
                        </div>
                    </div>
                    <div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                        <div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                            ...
                            <a rel="noopener noreferrer" href="#"
                                class="inline-block w-full px-5 py-3 font-semibold tracki text-center rounded dark:bg-rose-400 dark:text-gray-900">Get
                                Started</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container px-6 py-12 mx-auto">
                <div class="grid items-center gap-4 xl:grid-cols-5">
                    <div class="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
                        ...
                        <p class="dark:text-gray-400">Pri ex magna scaevola moderatius. Nullam accommodare no vix, est
        ...
        <section class="dark:bg-gray-800 dark:text-gray-100">
            <div class="container flex flex-col justify-center p-4 mx-auto md:p-8">
                ...
                <div class="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 dark:divide-gray-700">
                    <details>
                        <summary class="py-2 outline-none cursor-pointer focus:underline">Optio maiores eligendi
                    ...
                    <details>
                        <summary class="py-2 outline-none cursor-pointer focus:underline">Modi dolorem veritatis culpa
                    ...
                    <details>
                        ...
                        <div class="px-4 pb-4 space-y-2">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut voluptates aspernatur dolores
                                in consequatur doloremque inventore reprehenderit, consequuntur perspiciatis architecto.
                            </p>
        ...
        <!-- Footer -->
        <footer class="border-t border-gray-700 px-4 py-8 dark:bg-gray-800 dark:text-gray-400">
            <div
                ...
                <div class="flex flex-row pr-3 space-x-4 sm:space-x-8">
                    <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-full dark:bg-rose-400">
