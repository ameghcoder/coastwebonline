...
<html lang="en" class="scroll-smooth">
  ...
  <body class="bg-white dark:bg-gray-800">
    <div class="flex flex-col w-full h-screen justify-between">
      <!-- Header -->
      <header
        class="shadow-md p-4 bg-white dark:bg-gray-800 text-neutrael-400 dark:text-gray-100"
      >
        <div
          class="container flex justify-between h-16 mx-auto md:justify-center md:space-x-8"
        >
      ...
      <!--  First -->
      <section
        class="mt-2 bg-white dark:bg-gray-800 text-neutrael-400 dark:text-gray-100"
      >
        <div
        ...
        >
          ...
          >
            ...
            <p class="mt-6 mb-8 text-lg sm:mb-12">
              ...
              <br class="hidden md:inline lg:hidden" /><span
                class="text-rose-400"
                >free life time support</span
              >
            </p>
            <div
            ...
            >
              <a
                rel="noopener noreferrer"
                href="#"
                class="px-8 py-3 text-lg font-semibold rounded bg-rose-400 text-gray-900"
                >Contact us</a
              >
              <a
                rel="noopener noreferrer"
      ...
      <!-- Second -->
      <section
        class="m-4 md:m-8 bg-white dark:bg-gray-800 text-neutrael-400 dark:text-gray-100"
        id="servicing"
      >
        ...
        <div
          class="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3"
        >
        ...
        <form novalidate="" class="space-y-6">
          <div>
            ...
            <input
              ...
              type="text"
              placeholder=""
              class="w-full p-3 rounded bg-slate-100 dark:bg-slate-600"
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            class="w-full p-3 text-sm font-bold tracki uppercase rounded bg-rose-400 text-gray-900"
          >
            Send Message
          </button>
        </form>
      ...
      <!-- Fourth -->
      <section
        class="py-6 bg-white dark:bg-gray-800 text-neutrael-400 dark:text-gray-100"
        id="about"
      >
        <div
        ...
        >
          ...
          <div class="flex flex-row flex-wrap-reverse justify-center">
            <div class="flex flex-col justify-center m-8 text-center">
              <img
                alt=""
                class="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full bg-gray-500"
                src="./yash.jpg"
              />
      ...
      <hr class="w-1/2 m-auto border-t border-gray-700" />
      <section
        class="py-20 bg-white dark:bg-gray-800 text-neutrael-400 dark:text-gray-100"
        id="pricing"
      >
        <div class="container px-4 mx-auto">
          <div class="max-w-2xl mx-auto mb-16 text-center">
            <span class="font-bold tracki uppercase text-rose-400"
              >Pricing</span
            >
          ...
          <div class="flex flex-wrap items-stretch -mx-4">
            ...
            <div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div
                class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-rose-400 text-gray-900"
              >
                <div class="space-y-2">
                ...
                <a
                  rel="noopener noreferrer"
                  href="#"
                  class="inline-block w-full px-5 py-3 font-bold tracki text-center rounded bg-white dark:bg-gray-800 text-rose-400"
                  >Get Started</a
                >
              </div>
            </div>
            <div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              ...
              >
                ...
                <a
                  rel="noopener noreferrer"
                  href="#"
                  class="inline-block w-full px-5 py-3 font-semibold tracki text-center rounded bg-rose-400 text-gray-900"
                  >Get Started</a
                >
              </div>
            </div>
      ...
      <!-- Fifth -->
      <section
        class="bg-white dark:bg-gray-800 text-neutrael-400 dark:text-gray-100"
      >
        <div class="container px-6 py-12 mx-auto">
          <div class="grid items-center gap-4 xl:grid-cols-5">
            <div
              class="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left"
            >
              ...
              <button
                type="button"
                class="px-8 py-3 font-semibold rounded-full !dark:bg-pink-500"
              >
                Rounded
              </button>
            </div>
            ...
            <div class="p-6 xl:col-span-3">
              <div class="grid gap-4 md:grid-cols-2">
                <div class="grid content-center gap-4">
                  <div
                    class="p-6 rounded shadow-md dark:bg-gray-800 bg-slate-100 shadow-lg"
                  >
                    <p>
      ...
      <!-- Footer -->
      <footer
        class="border-t border-gray-700 px-4 py-8 bg-white dark:bg-gray-800 text-gray-400"
      >
        <div
        ...
        >
          <div class="flex flex-row pr-3 space-x-4 sm:space-x-8">
            <div
              class="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-full bg-rose-400"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
            ...
            <ul class="flex flex-wrap items-center space-x-4 sm:space-x-8">
              <li>
                <a rel="noopener noreferrer" href="./termsandconditions.html"
                  >Terms of Use</a
                >
              </li>
              <li>
